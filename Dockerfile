...
RUN if [ "$BUILDPLATFORM" = "$TARGETPLATFORM" ]; then \
        ...
        wget -q "https://github.com/cross-tools/musl-cross/releases/download/20260430/$(cat /tmp/arch)-unknown-linux-musl.tar.xz" && \
        echo "9303385fc29f8197004f641f96382196d56e4ec6dd975bff8ddd66641378628d $(cat /tmp/arch)-unknown-linux-musl.tar.xz" | sha256sum --check --status && \
        mkdir -p /opt/x-tools && \
